...
define(["require", "exports", "esri/WebMap", "esri/views/MapView", "esri/renderers/smartMapping/creators/color", "esri/widgets/Legend"], function (require, exports, WebMap, MapView, colorRendererCreator, Legend) {
    ...
    var fieldName;
    var normalizationFieldName = "EDUCA_BASE";
    var fieldSelect;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, view.map.layers.getItemAt(0).load()];
                    case 2:
                        layer = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        stats = _a.sent();
                        totalValue = stats[0].attributes[fieldName + "_TOTAL"];
                        totalNormalizationValue = stats[0].attributes[normalizationFieldName + "_TOTAL"];
